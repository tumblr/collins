...
case class AssetLog(
    ...
    message: String,
    id: Long = 0) extends ValidatedEntity[Long] with CallbackDatum {
  ...
  override def compare(z: Any): Boolean = {
    ...
    if (!ar.getClass.isAssignableFrom(this.getClass))
      ...
      val other = ar.asInstanceOf[AssetLog]
      this.assetId == other.assetId && this.created == other.created && this.createdBy == other.createdBy && this.format == other.format &&
        this.source == other.source && this.message == other.message
    }
  }
...
object AssetLog extends Schema with AnormAdapter[AssetLog] with AssetLogKeys {
  ...
  def apply(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource, mt: LogMessageType): AssetLog = {
    AssetLog(asset.id, new Date().asTimestamp, createdBy, format, source, mt, message)
  }
  ...
  def emergency(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Emergency)
  }
  ...
  def critical(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Critical)
  }
  ...
  def alert(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Alert)
  }
  ...
  def error(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Error)
  }
  ...
  def warning(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Warning)
  }
  ...
  def notice(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Notice)
  }

  def note(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Note)
  }
  ...
  def informational(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Informational)
  }

  //Info useful to developers for debugging the application, not useful during operations
  def debug(asset: Asset, createdBy: String, message: String, format: LogFormat, source: LogSource) = {
    AssetLog(asset, createdBy, message, format, source, LogMessageType.Debug)
  }
