...
Service-bootstrap has created a fully-functional Scala service for
...
or you can run it via the `run` script like:
    ...
    $ ./run com.tumblr..Main -f config/development.scala
...
is named "serx", there should be a `serx.log` with contents like this:
...
For more about testing with specs see [the scala school specs docs(http://tumblr.github.com/scala_school/specs.html)
...
For more about SBT see [the scala school sbt docs](http://tumblr.github.com/scala_school/sbt.html)
