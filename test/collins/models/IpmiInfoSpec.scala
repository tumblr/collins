  ...
  "The IpmiInfo Model" should {
    ...
    "Support find methods" in new WithApplication {
      ...
      "createForAsset is next address" in {
        ...
        IpmiInfo.createForAsset(a1, None).dottedAddress mustEqual "172.16.32.20"
        IpmiInfo.createForAsset(a2, None).dottedAddress mustEqual "172.16.32.21"
        IpmiInfo.createForAsset(a3, None).dottedAddress mustEqual "172.16.32.22"
      ...
      "createForAsset with reuse in range" in {
        ...
        val ipmi4 = IpmiInfo.createForAsset(a4, None)
